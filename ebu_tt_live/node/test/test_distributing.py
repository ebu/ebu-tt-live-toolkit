...
class TestDistributingNode(TestCase):
    ...
    def test_process_document(self):
        ...
        self.distributing_node.producer_carriage.emit_data.assert_called_with(data=document.get_xml())
    ...
    def test_process_document_raw_xml(self):
        ...
        self.distributing_node.producer_carriage.emit_data.assert_called_with(data=raw_xml)
