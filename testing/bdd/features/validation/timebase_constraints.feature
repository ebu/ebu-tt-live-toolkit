Feature: ttp:timebase-related attribute constraints
  ...
  Scenario: Invalid types according to timebase
    ...
    | timebase.xml  | clock     | 20:05:10.0    | 10:00:05.20   |               |
    ...
    | timebase.xml  | media     | 200:05:10.0   | 100:00:05.20  |               |


  @skip
  Scenario: Invalid types according to timebase in body childs
    Given an xml file <xml_file>
    And it has timeBase <time_base>
    And it has body begin time <body_begin>
    And it has body end time <body_end>
