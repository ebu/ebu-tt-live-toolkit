...
Feature: Computed times computation
  ...
  Scenario: Resolved times on a single document
    ...
    Examples:
    | time_base | body_begin  | body_end     | body_dur | div_begin   | div_end     | p_begin    | p_end      | span_begin  | span_end    | computed_begin | computed_end | avail_time  |
