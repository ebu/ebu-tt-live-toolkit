...
|R109|2.3.4.1|Buffer and Retiming Delay nodes SHALL accept a non-negative offset value | |
...
|R116|2.3.4.2|~~A Retiming Delay node shall not emit an output sequence with reordered subtitles.~~|Replaced by 'Should'.|
