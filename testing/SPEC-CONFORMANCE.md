...
|R122|3.2.2.1|The data type of `ebuttp:authorsGroupControlToken` shall be a positive integer.||
|R123|3.2.2.1|The data type of `ebuttp:sequenceNumber` shall be a positive integer.||
|R124|3.2.2.1|The data type of `ebuttp:sequenceIdentifier` shall be a string of length >= 1.||
|R125|3.2.2.1|The data type of `ebuttp:authorsGroupIdentifier` shall be a string of length >= 1.||
