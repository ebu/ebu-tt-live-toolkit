...
|R96|4.6|`ttp:frameRateMultiplier` values SHALL be constrained to two positive integers delimited by space|`bdd/features/validation/smpte_constraints.feature` `(In)valid SMPTE head attributes`|
